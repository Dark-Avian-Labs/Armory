...
export function RivenBuilder({
  ...
  return (
    <Modal
      open
      onClose={onClose}
      className="modal--popover-host glass-modal-surface max-h-[90vh] w-[90%] max-w-lg overflow-y-auto"
      ariaLabelledBy="riven-builder-title"
    >
      <div className="modal--popover-host-scroll">
        <div className="mb-4 flex items-center justify-between">
          <h3 id="riven-builder-title" className="text-foreground text-sm font-semibold">
            Riven Builder
          </h3>
          <button
            type="button"
        ...
        <div className="modal-actions">
          <button type="button" className="btn btn-cancel text-xs" onClick={onClose}>
            Cancel
          </button>
          <button
            type="button"
